...
const AnimatedList = ({
  ...
  return (
    <div className={`relative  ${className} bg-blue-100 h-[80vh] w-[88vw] rounded-lg pt-10`}>
      <div
        ref={listRef}
      ...
      >
        {items.map((item, index) => (
          ...
          >
             {/* room chat */}
            <div className={ `p-4 bg-[#111]  rounded-lg ${selectedIndex === index ? 'bg-white' : 'bg-white'} ${itemClassName} flex`}>
